...
1. 读取 `<project>/.copilot/agents/reviewer/state.json` — 恢复当前状态
2. 读取 `<project>/.copilot/agents/reviewer/inbox.json` — 检查消息
...
在 `<project>/.copilot/agents/reviewer/workspace/review-reports/` 下输出:
