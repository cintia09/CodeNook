...
1. 读取 `<project>/.copilot/agents/designer/state.json` — 恢复当前状态
2. 读取 `<project>/.copilot/agents/designer/inbox.json` — 检查消息
...
设计完成后, 在 `<project>/.copilot/agents/designer/workspace/` 下输出:
