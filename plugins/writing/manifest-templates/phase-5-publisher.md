# Phase-5 dispatch manifest -- publisher

> Template rendered by orchestrator-tick into
> `.codenook/tasks/{task_id}/prompts/phase-5-publisher.md` before
> dispatching the publisher role.
...
```
.codenook/tasks/{task_id}/outputs/phase-5-publisher.md
```
