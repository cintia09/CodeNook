# Phase-2 dispatch manifest -- drafter

> Template rendered by orchestrator-tick into
> `.codenook/tasks/{task_id}/prompts/phase-2-drafter.md` before
> dispatching the drafter role.
...
```
.codenook/tasks/{task_id}/outputs/phase-2-drafter.md
```
