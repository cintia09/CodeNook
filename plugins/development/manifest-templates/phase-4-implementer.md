# Phase-4 dispatch manifest — implementer

> Template rendered by orchestrator-tick into
> `.codenook/tasks/{task_id}/prompts/phase-4-implementer.md` before
> dispatching the implementer role.
...
```
.codenook/tasks/{task_id}/outputs/phase-4-implementer.md
```
