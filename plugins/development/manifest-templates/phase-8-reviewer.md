# Phase-8 dispatch manifest — reviewer

> Template rendered by orchestrator-tick into
> `.codenook/tasks/{task_id}/prompts/phase-8-reviewer.md` before
...
Final reviewer sign-off; package shippable artefacts.
...
```
.codenook/tasks/{task_id}/outputs/phase-8-reviewer.md
```
