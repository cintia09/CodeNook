# Phase-2 dispatch manifest -- analyzer

> Template rendered by orchestrator-tick into
> `.codenook/tasks/{task_id}/prompts/phase-2-analyzer.md` before
> dispatching the analyzer role.
...
```
.codenook/tasks/{task_id}/outputs/phase-2-analyzer.md
```
