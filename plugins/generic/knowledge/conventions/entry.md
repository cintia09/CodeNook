...
summary: Cross-phase conventions for the generic plugin pipeline, read by every role on demand. Captures output style (plain markdown, ATX headings), file naming, and the small set of rules that keep the fallback pipeline predictable.
tags:
  - generic
  - conventions
  - plugin-shipped
