...
|---|---|---|---|
| 🛠️ **`development`** | `v0.5.2` | Software delivery — feature work, hotfixes, refactors, docs, reviews. | `clarify → design → plan → dfmea → implement → build → review → submit → test-plan → test → accept → ship` |
