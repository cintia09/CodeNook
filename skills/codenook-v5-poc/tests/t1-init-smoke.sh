...
check ".codenook/prompts-templates/designer.md"
check ".codenook/prompts-templates/planner.md"
...
check ".codenook/prompts-templates/tester.md"
check ".codenook/prompts-templates/acceptor.md"
check ".codenook/prompts-templates/validator.md"
check ".codenook/prompts-criteria/criteria-clarify.md"
check ".codenook/prompts-criteria/criteria-design.md"
check ".codenook/prompts-criteria/criteria-plan.md"
check ".codenook/prompts-criteria/criteria-implement.md"
check ".codenook/prompts-criteria/criteria-review.md"
check ".codenook/prompts-criteria/criteria-test.md"
check ".codenook/prompts-criteria/criteria-accept.md"
check ".codenook/agents/clarifier.agent.md"
check ".codenook/agents/designer.agent.md"
check ".codenook/agents/planner.agent.md"
...
check ".codenook/agents/tester.agent.md"
check ".codenook/agents/acceptor.agent.md"
