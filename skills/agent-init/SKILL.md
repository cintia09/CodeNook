...
cat ~/.claude/agents/implementer.agent.md
cat ~/.claude/agents/reviewer.agent.md
cat ~/.claude/agents/tester.agent.md
```
...
cat ~/.claude/skills/agent-implementer/SKILL.md
cat ~/.claude/skills/agent-reviewer/SKILL.md
cat ~/.claude/skills/agent-tester/SKILL.md
cat ~/.claude/skills/agent-fsm/SKILL.md
cat ~/.claude/skills/agent-task-board/SKILL.md
```
...
for hook in agent-session-start.sh agent-pre-tool-use.sh agent-post-tool-use.sh agent-staleness-check.sh; do
  if [ -f ~/.claude/hooks/"$hook" ]; then
    cp ~/.claude/hooks/"$hook" .agents/hooks/"$hook"
