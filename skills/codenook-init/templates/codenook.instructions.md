# CodeNook Orchestration Engine (v4.9.5)
...
PHASE_ENTRY_QUESTIONS = {
  ...
  "test_plan": [
    { "key": "reference_sources", "prompt": "测试计划需要参考哪些外部文档/来源？ / External references for test plan?",
      "choices": ["仅项目内文档 / Project docs only ★",
                  "Confluence (提供链接) / Confluence (provide link)",
                  "Jira (提供Issue号) / Jira (provide issue ID)",
                  "Gerrit (提供Change号) / Gerrit (provide change ID)",
                  "多个来源 / Multiple sources (specify)"] },
  ...
  "accept_plan": [
    { "key": "reference_sources", "prompt": "验收计划需要参考哪些外部文档/来源？ / External references for acceptance plan?",
      "choices": ["仅项目内文档 / Project docs only ★",
                  "Confluence (提供链接) / Confluence (provide link)",
                  "Jira (提供Issue号) / Jira (provide issue ID)",
                  "Gerrit (提供Change号) / Gerrit (provide change ID)",
